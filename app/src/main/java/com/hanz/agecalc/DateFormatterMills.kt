...
class DateFormatterMills {
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    fun dateToString(date: LocalDate, strPattern: String = "dd MMMM, yyyy"): String {
        val dateFormatter = DateTimeFormatter.ofPattern(strPattern, Locale.getDefault())
